...
[p03：制作博客公用头部并形成组件](https://jspang.com/detailed?id=52#toc210)
...
[编写`advert.css`文件](https://jspang.com/detailed?id=52#toc326)
...
[认识egg.js框架](https://jspang.com/detailed?id=52#toc342)
...
[创建数据库](https://jspang.com/detailed?id=52#toc354)
...
<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=124140226&amp;page=17" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>
...
[p22：前台文章列表页的制作1-接口模块化和读取文章分类](https://jspang.com/detailed?id=52#toc279)

从这节课开始，要制作一下文章列表页的前中台结合。由于接口越来越多，现在这样零散的管理非常不利于日后的维护，所以需要单独一个文件，专门用于前台和中台的接口管理。这样在以后部署和更换服务器时都非常简单。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=126313292&amp;page=22" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[编写统一中台API配置文件](https://jspang.com/detailed?id=52#toc380)
...
[修改首页接口 读取文章类别信息](https://jspang.com/detailed?id=52#toc381)
...
[修改数据库](https://jspang.com/detailed?id=52#toc382)
...
[修改Header组件](https://jspang.com/detailed?id=52#toc383)
...
[p23：前台文章列表页的制作2-根据类别读取文章列表](https://jspang.com/detailed?id=52#toc284)

现在已经可以进入到文章列表页，但是列表页的内容现在还是静态的。我们的意愿是根据文章类别来展现不同的内容，比如视频列表就全部都是视频，大胖逼逼叨就全是我的唠嗑内容。要实现这个效果，我们还是需要制作一个接口的。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=126491773&amp;page=23" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[编写根据类别ID获取文章列表接口](https://jspang.com/detailed?id=52#toc385)
...
[路由和接口管理文件](https://jspang.com/detailed?id=52#toc386)
...
[编写前台UI界面](https://jspang.com/detailed?id=52#toc387)
...
[p24：让前台所有页面支持Markdown解析](https://jspang.com/detailed?id=52#toc288)
...
[首页对Markdown语法的解析](https://jspang.com/detailed?id=52#toc389)
...
[p25：后台开发01-开发环境搭建](https://jspang.com/detailed?id=52#toc290)

前台的主要功能我们已经开发完成了，接下来我们开始制作后台博客的管理界面。后台将采用`React Hooks + Ant Design`,我们主要会对博客文章的管理和登录系统进行讲解。本节课主要是搭建后端开发环境。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=128897348&amp;page=25" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[用脚手架生成项目](https://jspang.com/detailed?id=52#toc391)
...
[安装和引入Ant Design](https://jspang.com/detailed?id=52#toc392)
...
[p26：后台开发02-页面路由配置](https://jspang.com/detailed?id=52#toc293)

开发环境搭建好以后，接下来就可以设置路由了。路由的设置相当简单，所以这节课的时间也不会太长。（如果你还不熟悉React-router相关知识，可以到我的博客中看一下Router基础9节课）

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=129076407&amp;page=26" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[安装 react-router-dom](https://jspang.com/detailed?id=52#toc394)
...
[使用Router](https://jspang.com/detailed?id=52#toc395)
...
[p27：后台管理系统开发03-编写登录界面](https://jspang.com/detailed?id=52#toc296)

现在可以编写界面了，我们第一个界面就是登录，因为后台管理的一切都要求我们登录后才可以操作。如果没登录会跳转到登录。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=129339315&amp;page=27" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[引入需要使用的组件](https://jspang.com/detailed?id=52#toc397)
...
[编写UI部分](https://jspang.com/detailed?id=52#toc398)
...
[编写CSS文件](https://jspang.com/detailed?id=52#toc399)
...
[p28：后台开发04-UI框架搭建](https://jspang.com/detailed?id=52#toc2100)

登录页面的UI制作完成了，当登录成功后，我们会跳转到博客的后台管理页面，这个页面依然是用`Ant Desgin`制作的。这里直接用官方提供的案例来作。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=129431645&amp;page=28" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[Layout布局](https://jspang.com/detailed?id=52#toc3101)
...
[把Class形式改为Hooks形式](https://jspang.com/detailed?id=52#toc3102)
...
[p29：后台开发05-添加文章页面制作1](https://jspang.com/detailed?id=52#toc2103)

大体的UI架构确定下来以后，就可以制作里边的业务逻辑页面了，第一个要作的页面是添加博客文章，这是本套视频最难的一部分，所以要分成几节课来讲。这节课我们先做出标题和内容部分。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=130668850&amp;page=29" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

我们要制作的增加文章页面图片。

![react-markdown](https://jspang.com/images/react-blog100.png)

[创建增加文章页面](https://jspang.com/detailed?id=52#toc3104)
...
[编写标题和文章内容区域](https://jspang.com/detailed?id=52#toc3105)
...
[p30：后台开发06-添加文章页面制作2](https://jspang.com/detailed?id=52#toc2106)

这节课继续上节课完成界面制作，那我们就话不多说，直接写代码了。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=130938427&amp;page=30" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[暂存按钮和发布按钮](https://jspang.com/detailed?id=52#toc3107)
...
[编写文章简介部分](https://jspang.com/detailed?id=52#toc3108)
...
[编写发布时间界面](https://jspang.com/detailed?id=52#toc3109)
...
[p31：后台管理系统开发07-Markdown编辑器制作](https://jspang.com/detailed?id=52#toc2110)

界面制作好以后，我们可以自己制作一个Markdown编辑器，我们作的也没内那么麻烦，只要支持Markdown语法的编写，并且能实时预览就可以。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=131504961&amp;page=31" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[声明对应的useState](https://jspang.com/detailed?id=52#toc3111)
...
[设置marked](https://jspang.com/detailed?id=52#toc3112)
...
[编写实时预览对应的方法](https://jspang.com/detailed?id=52#toc3113)
...
[编写onChange相应事件](https://jspang.com/detailed?id=52#toc3114)
...
[p32：后台开发08-编写service登录接口](https://jspang.com/detailed?id=52#toc2115)

现在我们已经有了连个最基础的后台页面，可以作登录的业务逻辑制作了。这节课就制作一下中台的登录接口。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=131702481&amp;page=32" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[新建main.js文件](https://jspang.com/detailed?id=52#toc3116)
...
[中台路由的制作](https://jspang.com/detailed?id=52#toc3117)
...
[登录方法的编写](https://jspang.com/detailed?id=52#toc3118)
...
[p33：后台开发09-实现前台登录操作](https://jspang.com/detailed?id=52#toc2119)

上节课已经把后台的登录接口和数据库制作好了，这节课就主要实现前台和后台的对接。当然这也不是登录的全部，登录全部我们还要作登录守卫，这个我们可以放在下节课来学习。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=132182312&amp;page=33" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[设置路由](https://jspang.com/detailed?id=52#toc3120)
...
[后台登录方法编写checkLogin](https://jspang.com/detailed?id=52#toc3121)
...
[增加相应事件](https://jspang.com/detailed?id=52#toc3122)
...
[p34：后台开发10-中台路由守卫制作](https://jspang.com/detailed?id=52#toc2123)

现在我们的博客系统已经可以登录了，并且登录后，我们生成了session，通过后台是不是存在对应的session，作一个中台的路由守卫。如果没有登录，是不允许访问后台对应的接口，也没办法作对应的操作。这样就实现了接口的安全。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=132947253&amp;page=34" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[编写守卫方法](https://jspang.com/detailed?id=52#toc3124)
...
[前后台分离共享session的方法](https://jspang.com/detailed?id=52#toc3125)
...
[使用中间件实现路由守卫](https://jspang.com/detailed?id=52#toc3126)
...
[p35：后台开发11-读取添加文章页面的类别信息](https://jspang.com/detailed?id=52#toc2127)

上节课我们把后台添加文章的UI和守卫都已经作好了，那这节课制作从后台开一个读取文章类别的接口，然后从接口中获得数据，展现在添加文章页面上，方便以后选择文章类别，重点是联系如何通过路由守卫守护接口的。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=135179587&amp;page=35" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[编写获取文章类别的接口](https://jspang.com/detailed?id=52#toc3128)
...
[编写中台路由](https://jspang.com/detailed?id=52#toc3129)
...
[后台apiUrl.js的设置](https://jspang.com/detailed?id=52#toc3130)
...
[在添加文章页面显示出类别](https://jspang.com/detailed?id=52#toc3131)
...
[P36：后台开发12-添加文章的方法(上)](https://jspang.com/detailed?id=52#toc2132)

这节的目的就是把文章中的内容添加到数据库中，内容虽然比较多，但是很多知识我们已经熟悉，都是利用`axios`对数据库进行操作。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=135478154&amp;page=36" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[选择类别后调用方法](https://jspang.com/detailed?id=52#toc3133)
...
[对发布时间文本框修改](https://jspang.com/detailed?id=52#toc3134)
...
[再对文章标题文本框进行修改](https://jspang.com/detailed?id=52#toc3135)
...
[编写文章保存方法](https://jspang.com/detailed?id=52#toc3136)
...
[P37：后台开发13-添加文章的方法(中)](https://jspang.com/detailed?id=52#toc2137)

接着上节课的内容继续完成添加文章的方法，这节课主要是完善中台接口和后台的`saveArticle`方法。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=135478154&amp;page=37" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[编写中台的addArticle接口](https://jspang.com/detailed?id=52#toc3138)
...
[编写对应的路由](https://jspang.com/detailed?id=52#toc3139)
...
[配置apiUrl.js文件](https://jspang.com/detailed?id=52#toc3140)
...
[编写saveArticle方法](https://jspang.com/detailed?id=52#toc3141)
...
[P38：后台开发14-添加文章的方法(下)](https://jspang.com/detailed?id=52#toc2142)

这节继续晚上后台文章的添加，上节课已经实现了加入数据库，但加入后如果我们再改动，再点击保存按钮就会又新增加一条记录，这并不是我们想要的，这时候应该是修改，而不是从新增加一条新的数据。我们这节就主要实现这个功能。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=135831442&amp;page=38" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[编写中台接口方法](https://jspang.com/detailed?id=52#toc3143)
...
[后台apiUrl.js的配置](https://jspang.com/detailed?id=52#toc3144)
...
[后台保存方法的修改](https://jspang.com/detailed?id=52#toc3145)
...
[P39：后台开发15-文章列表制作(上)](https://jspang.com/detailed?id=52#toc2146)

目前已经可以添加博客文章了，然后我们需要作一个文章列表，方便我们后续的删除和修改操作。我们先把接口和页面布局做好。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=136075961&amp;page=39" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[建立ArticleList.js文件](https://jspang.com/detailed?id=52#toc3147)
...
[编写对应的路由](https://jspang.com/detailed?id=52#toc3148)
...
[P40：后台开发16-文章列表制作(中)](https://jspang.com/detailed?id=52#toc2149)

这节的主要内容就是编写中台的列表方法，然后通过方法读取数据并显示再页面上，有了博客前台读取首页列表数据的经验后，你做起来应该不算什么难事了。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=137758922&amp;page=40" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[编写中台获取文章列表接口](https://jspang.com/detailed?id=52#toc3150)
...
[配置apiUrl.js文件](https://jspang.com/detailed?id=52#toc3151)
...
[后台Axios获取文章列表](https://jspang.com/detailed?id=52#toc3152)
...
[P41：后台开发17-删除文章](https://jspang.com/detailed?id=52#toc2153)

列表上节课已经完成了，但是列表就是为了更方便的管理博客文章，这节我们就一起来完成文章的删除操作。删除操作需要注意的是要防止误删，就是不小心删错了，所以在删除前我们需要再次向用户询问是否删除。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=126313292&amp;page=22" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[删除文章中台方法编写](https://jspang.com/detailed?id=52#toc3154)
...
[编写apiUrl.js文件](https://jspang.com/detailed?id=52#toc3155)
...
[管理页面删除方法编写](https://jspang.com/detailed?id=52#toc3156)
...
[P42：后台开发18-修改文章（上）](https://jspang.com/detailed?id=52#toc2157)
...
<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=138202665&amp;page=42" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[编写中台接口方法](https://jspang.com/detailed?id=52#toc3158)
...
[修改apiUrl.js文件](https://jspang.com/detailed?id=52#toc3159)
...
[updateArticle方法编写](https://jspang.com/detailed?id=52#toc3160)
...
[P43：后台开发19-修改文章（下）](https://jspang.com/detailed?id=52#toc2161)

继续上节课作博客后台文章的修改，上节课已经可以跳转到添加页面了，这节课的主要内容就是把从接口中得到的数据，显示在页面上，然后进行修改。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=138526571&amp;page=43" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>

[getArticleById方法的编写](https://jspang.com/detailed?id=52#toc3162)
...
[useEffect()方法的编写](https://jspang.com/detailed?id=52#toc3163)
...
[P44：博客部署介绍和演示](https://jspang.com/detailed?id=52#toc2164)

部署这套博客有很多种方法，也可以自动化部署。但你如果想学会部署，并且不花什么钱的的话，你至少要会以下这些知识。

<iframe src="https://player.bilibili.com/player.html?aid=68325396&amp;cid=138913188&amp;page=44" scrolling="no" border="0" frameborder="no" framespacing="0" allowfullscreen="true" width="100%" style="box-sizing: border-box; height: 34rem; border: 1px solid rgb(61, 61, 61); border-radius: 8px;"></iframe>
...
[Blog前台部署](https://jspang.com/detailed?id=52#toc3165)
...
[中台的开启](https://jspang.com/detailed?id=52#toc3166)
...
[后台管理的启用](https://jspang.com/detailed?id=52#toc3167)
...
[写在最后](https://jspang.com/detailed?id=52#toc3168)
